...
- Accumulated surface runoff, which is an Ecosystem Service of water regulation, as it represents the excess of water that will directly flow into the rivers, what makes it susceptible to generate floods (file *_Exp.asc in mm).
...
All the input and output maps use ED50 UTM zone 30-North projection (EPSG:23030)
